...
#ifdef CONFIG_MACH_REALME_TRINKET //YiXue.Ge@PSW.BSP.Kernel.Stablity, 2018-10-26 add for enable pmic wd
...
#ifdef CONFIG_MACH_REALME_TRINKET /* yanghao@PSW.Kernel.Stability add for debug suspend crash problem */
